/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 04d97308b6cf53e065927e3a5c1c7b20)
...
interface __BaseEnv_Env {
	...
	SECONDS_PER_DAY: "30";
	StudyCoach: DurableObjectNamespace<import("./src/server/index").StudyCoach>;
	DECK_BUILDER: Workflow<Parameters<import("./src/server/index").DeckBuilder['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "StudyCoach";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MEMORY_MODE" | "AI_GATEWAY_ID" | "FIRST_REVIEW_DELAY_SECONDS" | "SECONDS_PER_DAY">> {}
}
